...
<section class="contact" id="contacto">
  <div class="contact-inner">
    <div class="contact-grid">
      ...
      <!-- Formspree: formulario de contacto de TEGA (destino tecnologia@tega.com.ar) -->
      <form class="form" id="contactForm" action="https://formspree.io/f/xgogzaqz" method="POST">
